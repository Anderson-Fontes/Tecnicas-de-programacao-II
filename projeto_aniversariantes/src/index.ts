...
async function enviarEmail(destinatario: string, email: string, assunto: string, corpo: string) {
    ...
    let message = {
        ...
        subject: assunto,
        html: corpo,
        // SEÇÃO ADICIONADA PARA INCORPORAR AS IMAGENS
        attachments: [
            {
                filename: 'logo.jpg',
                path: './src/imagens/logo.jpg', // Caminho para a imagem do logo
                cid: 'logo' // ID de conteúdo para a logo (usado no HTML)
            },
            {
                filename: 'assinatura.png',
                path: './src/imagens/assinatura.png', // Caminho para a imagem da assinatura
                cid: 'assinatura' // ID de conteúdo para a assinatura (usado no HTML)
            }
        ]
    };
